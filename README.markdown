...
| GetPdfFromHtml               | Accepts HTML content and returns the byte array of a PDF Document.                                                                                                                                                                                                                           |
| GetPowerPointFromHtml        | Accepts a list of HTML strings (slides) and returns the byte array of a PowerPoint Presentation.    
